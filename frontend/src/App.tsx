  ...
  return (
    <div className="flex h-screen bg-slate-100 dark:bg-slate-950 overflow-hidden">
      ...
      <div className={`flex-1 flex flex-col min-w-0 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'}`}>
        ...
        />
        <div className="flex-1 p-3 sm:p-4 lg:p-6 lg:pt-0 pt-0 overflow-hidden flex flex-col relative">
          <main className="flex-1 bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl overflow-hidden flex flex-col relative">
            <div className="flex-1 overflow-auto overflow-x-hidden w-full h-full">
              <Outlet />
            </div>
          </main>
        </div>

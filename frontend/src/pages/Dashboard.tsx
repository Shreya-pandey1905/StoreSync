...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="page-container space-y-4 sm:space-y-6 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-200">
            ...
            {/* Bar chart */}
            <div className="flex items-end justify-between gap-2 mt-6" style={{ height: `${MAX_BAR_HEIGHT + 32}px` }}>
              {salesData.map((day, i) => {
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-200">
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  ...
                  className="group w-full flex items-center justify-between p-3 sm:p-4 bg-slate-50 dark:bg-slate-700/40 hover:bg-blue-50 dark:hover:bg-blue-900/20 border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 rounded-lg sm:rounded-xl transition-all shadow-sm hover:shadow-md"
                >
